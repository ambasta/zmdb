...
The generated reachability row for `@zmdb/ai-vercel` and its clean packed-consumer proof both use the supported and tested floor, `ai@7.0.93`. Issue #748 aligned the manifest, lockfile, and external
consumer with the policy frozen by #746.
