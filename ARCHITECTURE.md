...
Measured from `scripts/product/catalog.mjs`, `scripts/architecture/policy.mjs`, `scripts/release/policy.mjs`, and the admitted manifests: **39 catalog packages**, **76 direct workspace edges**, **8
core packages**, **28 integration packages**, **3 tooling packages**, and canonical rings **0–6**.
...
| 5    | tooling     | tooling      | `@zmdb/cli`                | `@zmdb/migrations`<br>`@zmdb/sqlite`                                                                                                                                                |
| 5    | runtime     | integration  | `@zmdb/cockroach`          | `@zmdb/migrations`<br>`@zmdb/postgres`<br>`@zmdb/query-compiler`<br>`@zmdb/repository`                                                                                              |
| 5    | application | core         | `@zmdb/jobs`               | `@zmdb/app`<br>`@zmdb/query-compiler`<br>`@zmdb/repository`<br>`@zmdb/sqlite`                                                                                                       |
