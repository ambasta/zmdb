...
The generated reachability row for `@zmdb/ai-vercel` still reports the implemented manifest range `ai@^7.0.83`. It is not the support policy: #746 fixes the supported and tested floor at `ai@7.0.93`,
and #748 owns the later manifest, alias, lockfile, and packed-matrix changes.
