...
| 6    | facade      | core         | `zmdb`                     | `@zmdb/ai`<br>`@zmdb/aot-validator`<br>`@zmdb/app`<br>`@zmdb/compiler`<br>`@zmdb/migrations`<br>`@zmdb/query-compiler`<br>`@zmdb/repository`<br>`@zmdb/schema-core`<br>`@zmdb/web` |
