...
whose toolchain/build/contract is unavailable are recorded as *skipped with a
reason — never faked*. Run it with \`benchmarks/harness/framework/peers/peers-run.sh\`;
