...
<section class="section">
  ...
  <p class="lead">Composable and ESM-only. Combine the cohesive data, app, and HTTP facade with a database vertical, or use provider-neutral AI tools, opt-in client/framework, gRPC, NATS, RabbitMQ, Redis, MCP, OpenTelemetry, or another implementation package on its own.</p>
    ...
    <div class="pkg"><code>@zmdb/client/react</code><p>React context, query, and mutation lifecycle bindings for generated HTTP clients.</p></div>
    <div class="pkg"><code>@zmdb/client/react-native</code><p>React Native AppState, connectivity, credential-store, and offline lifecycle policy over the React client binding.</p></div>
    <div class="pkg"><code>@zmdb/client/angular</code><p>Angular dependency injection, signals, Observable cancellation, and request-local generated-client ownership.</p></div>
    <div class="pkg"><code>@zmdb/client/vue</code><p>Vue plugin, reactive query and mutation composables, scope cancellation, and per-application SSR isolation.</p></div>
    <div class="pkg"><code>@zmdb/client/svelte</code><p>Typed Svelte context, subscription-aware stores, stale-result suppression, and lifecycle cancellation.</p></div>
    ...
    <div class="pkg"><code>@zmdb/client/solid</code><p>Solid context, native resources, owner cancellation, stale-result suppression, and native Suspense/error propagation.</p></div>
    <div class="pkg"><code>@zmdb/next</code><p>Request-scoped App Router server clients and browser bindings over <code>@zmdb/client/react</code>.</p></div>
    <div class="pkg"><code>@zmdb/nuxt</code><p>Request-scoped Nitro transport, native hydration, and browser bindings over <code>@zmdb/client/vue</code>.</p></div>
    ...
    <div class="pkg"><code>@zmdb/app/otel</code><p>OpenTelemetry API adaptation over caller-owned tracers and meters, with no SDK, exporter, or ambient global context.</p></div>
