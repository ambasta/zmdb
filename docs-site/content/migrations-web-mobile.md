...
source file. `@zmdb/sqlite/embedded` remains a browser-safe compatibility re-export for existing SQLite consumers, but the migrations entry is the direct owner.
