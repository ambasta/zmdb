> **Install:** `npm add @zmdb/ai@1.0.0-beta.1 @zmdb/ai-langchain@1.0.0-beta.1 @langchain/core@^1.2.9`. The integration package is tested against `1.2.9` and declares that range as its sole optional
