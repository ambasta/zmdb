...
Install the CLI and its required TypeScript peer, or install `@zmdb/core@1.0.0-beta.1` for the product that includes the same CLI. Command help comes from the installed version:
