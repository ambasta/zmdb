...
Install the adapter and its sole external peer with `yarn add @zmdb/otel@1.0.0-beta.1 @opentelemetry/api@^1.9.1`. Neither is part of the `@zmdb/core` default install. The application selects and owns
