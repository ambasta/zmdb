> **Install:** `npm add @zmdb/ai@1.0.0-beta.1 @zmdb/mcp@1.0.0-beta.1 @zmdb/aot-validator@1.0.0-beta.1`. `@zmdb/mcp` depends only on `@zmdb/ai`, has no external peer, and does not install an MCP or
> provider SDK.
