...
| @zmdb/cli                | 1.0.0-alpha.4 | cli             | integration: database management CLI   | `npm add @zmdb/cli@1.0.0-alpha.4`                | Command-line interface for zmdb schema migrations, diffing, and database management.                                                                                                                                    | cli-overview                 |
