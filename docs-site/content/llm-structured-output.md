...
It tolerates fenced code blocks, leading prose, trailing commas and single quotes — the specific ways model output deviates from strict JSON. Typed parsing requires an explicit coercion callback to guarantee runtime shape validation.
