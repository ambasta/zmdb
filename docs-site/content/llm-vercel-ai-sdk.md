> **Install:** `yarn add @zmdb/ai@1.0.0-beta.1 @zmdb/ai-vercel@1.0.0-beta.1 ai@^7.0.93`. Exact `7.0.93` is the supported and packed-consumer-tested floor; `ai` is the adapter's sole optional peer.
