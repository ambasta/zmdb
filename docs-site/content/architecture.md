...
The current release classification covers every public row above exactly once: eight cohesive core packages, 28 independently versioned integrations, and two independently versioned tooling packages.
