...
The target release classification covers every public row above exactly once: eight cohesive core packages, 27 independently versioned integrations, and one independently versioned tooling package.
