> **Install:** `npm add @zmdb/ai@1.0.0-beta.1 @zmdb/schema-core@1.0.0-beta.1 @zmdb/aot-validator@1.0.0-beta.1`. Provider document dialects live in `@zmdb/ai`; that package has no provider SDK or
> framework peer.
