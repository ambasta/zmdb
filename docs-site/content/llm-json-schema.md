> **Install:** `npm add @zmdb/schema-core@1.0.0-beta.1` for runtime schema-to-JSON-Schema conversion; run `npm add @zmdb/ai@1.0.0-beta.1` for provider tool documents. JSON Schema ownership stays in
