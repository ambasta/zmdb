...
const { modelContent, aotContent, shallowContent } = withSession({ project: PROJECT }, session => {
...
`;
  ...
  return { modelContent: model, aotContent: aot, shallowContent: shallow };
});
...
for (const [path, content] of [
  [MODEL_OUT, modelContent],
  [AOT_OUT, aotContent],
  [SHALLOW_OUT, shallowContent],
]) {
  if (check) {
