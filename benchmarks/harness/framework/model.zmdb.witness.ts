/*zmdb:imports*/
// Generated by @zmdb/compiler from model.ts. Checked, not edited.
//
// One wrapper per validation call model.ts used to make, written against the runtime
...
export function zmdbAssertUserCreate(value: unknown): UserCreate {
  return assert<UserCreate>(value);
}
/*zmdb:end:zmdbAssertUserCreate*/
