...
//
// 1. turn #626's ownership policy, amended to 151 paths after #667, #681, #656, #668, #669, and #685, into an executable,
...
export const TARGET_TOOLING_MANIFESTS = Object.freeze({
  ...
  '@zmdb/cli': Object.freeze({
    dependencies: Object.freeze(['@zmdb/query-compiler', '@zmdb/sqlite']),
    peerDependencies: Object.freeze([]),
    optionalPeers: Object.freeze([]),
  }),
});
