...
const ENTRIES = {
  ...
  web: { '.': 'index', './routing': 'routing', './context': 'context', './di': 'di', './state': 'state', './pipeline': 'pipeline', './data': 'data', './modules': 'modules', './middleware': 'middleware', './app': 'app', './dto-pipes': 'dto-pipes', './openapi': 'openapi', './gateways': 'gateways', './testing': 'testing' },
