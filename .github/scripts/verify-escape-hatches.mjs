...
const BUDGET = {
  ...
  // 58. Type-bounded query builder signatures in query-compiler add row-bridge assertions.
  assertions: { limit: 58, what: 'type assertions (`as T` and `<T>x`, excluding `as const`)' },
