...
const BUDGET = {
  ...
  // 54. It was 53 on main; validateObject returning the data payload added 1 assertion (`data as T`).
  assertions: { limit: 54, what: 'type assertions (`as T` and `<T>x`, excluding `as const`)' },
