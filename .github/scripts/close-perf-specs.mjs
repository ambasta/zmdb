...
const MAP = {
  79: {
    spec: 'packages/validator/src/plugin/SPEC.md',
  ...
  84: {
    spec: 'packages/sql/src/joins/SPEC.md',
  ...
  89: {
    spec: 'packages/sql/src/aggregations/SPEC.md',
  ...
  94: {
    spec: 'packages/sql/src/fts/SPEC.md',
