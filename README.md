...
>
> The current suite has **2,803 passing tests** across 255 files, plus **120 expected failures** that describe work still to be done. The compatibility inventory covers 504 of 742 upstream API suites
