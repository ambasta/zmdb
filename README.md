...
>
> The current suite has **2,664 passing tests** across 233 files, plus **61 expected failures** that describe work still to be done. The compatibility inventory covers 504 of 742 upstream API suites
