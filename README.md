...
> and OpenAPI-derived tools** harness. **1,812 tests green** across 187 files,
...
> MikroORM, NestJS and Typia run between them: 489 are answered by a named zmdb
> test, 253 are argued against in writing, and `yarn verify:api-coverage` fails
