...
>
> The current suite has **2,705 passing tests** across 243 files, plus **99 expected failures** that describe work still to be done. The compatibility inventory covers 504 of 742 upstream API suites
