...
>
> The current suite has **2,638 passing tests** across 225 files, plus **2 expected failures** that describe work still to be done. The compatibility inventory covers 504 of 742 upstream API suites
