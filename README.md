...
>
> The current suite has **2,745 passing tests** across 248 files, plus **125 expected failures** that describe work still to be done. The compatibility inventory covers 504 of 742 upstream API suites
