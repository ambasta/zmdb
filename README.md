...
>
> The current suite has **2,672 passing tests** across 234 files, plus **63 expected failures** that describe work still to be done. The compatibility inventory covers 504 of 742 upstream API suites
