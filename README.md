...
>
> The current suite has **2,687 passing tests** across 241 files, plus **93 expected failures** that describe work still to be done. The compatibility inventory covers 504 of 742 upstream API suites
