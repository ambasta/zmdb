...
>
> The current suite has **2,809 passing tests** across 257 files, plus **101 expected failures** that describe work still to be done. The compatibility inventory covers 504 of 742 upstream API suites
