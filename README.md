...
>
> The current suite has **2,679 passing tests** across 238 files, plus **82 expected failures** that describe work still to be done. The compatibility inventory covers 504 of 742 upstream API suites
