...
>
> The current suite has **2,664 passing tests** across 232 files, plus **50 expected failures** that describe work still to be done. The compatibility inventory covers 504 of 742 upstream API suites
