...
>
> The current suite has **2,713 passing tests** across 245 files, plus **113 expected failures** that describe work still to be done. The compatibility inventory covers 504 of 742 upstream API suites
