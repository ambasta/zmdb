// Runtime coverage for packages/orm/src/outbox/SPEC.md §9 items 1, 2,
// 6, 7, 11 and 12, plus §8's documented duplicate.
//
// The outbox row, writer and dispatcher share the ORM owner with the SQL helpers.
// Items 3, 4, 5, 8, 9 and 10 are the SQL half and live in ./sql.spec.ts.
//
