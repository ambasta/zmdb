...
// Tests freeze (#593), the compile-time half of packages/orm/src/outbox/SPEC.md.
//
...
import { type HasDefault, type PrimaryKey, type Sql } from '@zmdb/schema/tags';
...
// `Sql<T>` is `{ readonly [zmdbSqlType]?: T }` in @zmdb/schema/tags, an
...
// instead of two. Verified 2026-09-04 against packages/orm/src/index.ts.
