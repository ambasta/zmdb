...
//
// The real-database tests execute the SQL helpers through `node:sqlite` with a small
// `execute` shim; the writer and dispatcher tests cover the driver integration separately.
