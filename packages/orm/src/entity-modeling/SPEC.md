...
## 1. Lifecycle events & subscribers (#142/#143/#144) — `@zmdb/orm`
...
## 2. Embeddables (#145/#146/#147) — `@zmdb/schema`
...
## 3. Inheritance mapping (#148/#149/#150) — `@zmdb/schema`
...
- Single-table inheritance: one table, a discriminator column selects the subtype; subtype-specific columns listed per type.
