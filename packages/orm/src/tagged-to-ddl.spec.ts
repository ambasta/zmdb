...
import { type CoreSchema, type CreateDTO, type PrimaryKeyOf, type TaggedSchema } from '@zmdb/schema';
import { type ColumnKeys, type DeclaredTable } from '@zmdb/schema/derive';
