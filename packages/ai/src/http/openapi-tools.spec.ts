...
// depends on nothing … It must never import a sibling" — `packages/schema/package.json`
...
describe('build-time module generation', () => {
  it('generates a deterministic formatter-clean module whose validators use the existing emitter', async () => {
    ...
    expect(generated).toContain("import type { MaxLength, MinLength } from '@zmdb/schema/tags';");
