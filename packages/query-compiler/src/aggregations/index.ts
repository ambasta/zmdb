...
export interface AggregateSelect {
  ...
  where(col: string, op: Operator | UnsafeOperator, value: unknown): AggregateSelect;
  orWhere(col: string, op: Operator | UnsafeOperator, value: unknown): AggregateSelect;
  whereGroup(predicates: readonly ComparisonPredicate[]): AggregateSelect;
  groupBy(...cols: string[]): AggregateSelect;
  having(col: string, op: Operator | UnsafeOperator, value: unknown): AggregateSelect;
