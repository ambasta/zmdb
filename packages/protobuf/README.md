...
`@zmdb/protobuf` has no runtime dependency or peer dependency and is not installed by `yarn add @zmdb/core@1.0.0-beta.2`. The build-time reflector/emitter is `@zmdb/compiler`; generated code imports
the wire runtime from this package.
