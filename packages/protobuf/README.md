...
`@zmdb/protobuf` has no runtime dependency or peer dependency and is not installed by `yarn add @zmdb/core@1.0.0-beta.2`. Dev dependency `@zmdb/compiler` is the build-time reflector/emitter; generated
