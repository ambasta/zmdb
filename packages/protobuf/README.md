...
`@zmdb/protobuf` has no runtime dependency or peer dependency and is not installed by `yarn add @zmdb/core@1.0.0-beta.2`. Its dev dependency is `@zmdb/compiler`, the build-time reflector/emitter;
generated code imports wire runtime here.
