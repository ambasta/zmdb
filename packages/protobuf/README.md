...
`@zmdb/protobuf` has no runtime dependency or peer dependency and is not installed by `yarn add @zmdb/core@1.0.0-beta.2`. Its development dependency is `@zmdb/compiler`, the build-time reflector/emitter; generated code imports the wire runtime from this package.
