...
byte-identical output. See `src/cli/SPEC.md`.
...
sets **and** identical issue paths", which is a property of two independent walks and is measured rather than asserted; see `src/emit/SPEC.md` §3 and `src/utilities/SPEC.md` §3.
