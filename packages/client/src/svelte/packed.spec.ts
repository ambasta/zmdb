...
function buildPackage(name: '@zmdb/client' | '@zmdb/client/svelte'): void {
...
describe('@zmdb/client/svelte packed consumers', () => {
  it(
...
`,
      ...
      try {
        expect([...result.tarballs.keys()].toSorted()).toEqual(['@zmdb/client']);
