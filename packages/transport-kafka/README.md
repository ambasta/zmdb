...
Kafka event transport for the @zmdb/core application messaging contract. Install with `yarn add @zmdb/transport-kafka kafkajs` and supply an explicitly configured Kafka client, consumer group, input
