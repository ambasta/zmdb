...
export const CALL_OWNERS: Readonly<Record<string, readonly string[]>> = Object.freeze({
  is: ['@zmdb/validator', '@zmdb/core', '@zmdb/core/validator'],
  isShallow: ['@zmdb/validator', '@zmdb/core/validator'],
  assert: ['@zmdb/validator', '@zmdb/core', '@zmdb/core/validator'],
  assertShallow: ['@zmdb/validator', '@zmdb/core/validator'],
  equals: ['@zmdb/validator', '@zmdb/core/validator'],
  assertEquals: ['@zmdb/validator', '@zmdb/core/validator'],
  validate: ['@zmdb/validator', '@zmdb/core', '@zmdb/core/validator'],
  validateShallow: ['@zmdb/validator', '@zmdb/core/validator'],
  random: ['@zmdb/validator', '@zmdb/core/validator'],
  toJsonSchema: ['@zmdb/schema/openapi', '@zmdb/core/schema'],
  schemaOf: ['@zmdb/schema', '@zmdb/core', '@zmdb/core/schema'],
  toolFor: ['@zmdb/ai'],
