...
export const CALL_OWNERS: Readonly<Record<string, readonly string[]>> = Object.freeze({
  is: ['@zmdb/aot-validator/utilities', 'zmdb', 'zmdb/validator'],
  isShallow: ['@zmdb/aot-validator/utilities', 'zmdb/validator'],
  assert: ['@zmdb/aot-validator/utilities', 'zmdb', 'zmdb/validator'],
  assertShallow: ['@zmdb/aot-validator/utilities', 'zmdb/validator'],
  equals: ['@zmdb/aot-validator/utilities', 'zmdb/validator'],
  assertEquals: ['@zmdb/aot-validator/utilities', 'zmdb/validator'],
  validate: ['@zmdb/aot-validator/utilities', 'zmdb', 'zmdb/validator'],
  validateShallow: ['@zmdb/aot-validator/utilities', 'zmdb/validator'],
  random: ['@zmdb/aot-validator/utilities', 'zmdb/validator'],
  toJsonSchema: ['@zmdb/schema-core/openapi', 'zmdb/schema'],
  schemaOf: ['@zmdb/schema-core', 'zmdb', 'zmdb/schema'],
  toolFor: ['@zmdb/ai'],
