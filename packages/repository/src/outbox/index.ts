...
export const OutboxSchema: CoreSchema<string> = schemaFromIR({
  ...
  relations: [],
  columns: [
    { ...EMPTY_COLUMN, name: 'id', sql: 'text', nullable: false, primaryKey: true, hasDefault: false },
    { ...EMPTY_COLUMN, name: 'topic', sql: 'text', nullable: false, hasDefault: false },
    { ...EMPTY_COLUMN, name: 'payload', sql: 'text', nullable: false, hasDefault: false },
    {
      ...EMPTY_COLUMN,
      name: 'status',
      sql: 'jsonEnum',
    ...
    { ...EMPTY_COLUMN, name: 'attempts', sql: 'integer', nullable: false, hasDefault: true },
    { ...EMPTY_COLUMN, name: 'created_at', sql: 'timestamp', nullable: false, hasDefault: true },
    { ...EMPTY_COLUMN, name: 'lease_owner', sql: 'text', nullable: false, hasDefault: true },
    { ...EMPTY_COLUMN, name: 'lease_until', sql: 'timestamp', nullable: false, hasDefault: true },
    { ...EMPTY_COLUMN, name: 'delivered_at', sql: 'timestamp', nullable: true, hasDefault: false },
    { ...EMPTY_COLUMN, name: 'last_error', sql: 'text', nullable: true, hasDefault: false },
  ],
});
