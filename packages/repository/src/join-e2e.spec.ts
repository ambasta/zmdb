...
beforeAll(async () => {
  try {
    ...
    await pool.query(`INSERT INTO j_products (id,name,supplier_id) VALUES (10,'Widget',1),(11,'Gadget',2),(12,'Orphan',NULL)`);
    reachable = true;
  } catch {
    reachable = false;
  }
...
const ProductSchema = {
  table: 'j_products',
  columns: { id: { type: 'serial', flags: { nullable: false, primaryKey: true } }, name: { type: 'text', flags: { nullable: false } } },
  primaryKey: ['id'],
  references: [],
