...
and `down` from `@zmdb/migrations`; transactional behavior follows the capability table below. Package-local migration and live integration tests cover this workflow.
...
Package-local dialect and live integration tests cover the SingleStore behavior. The [SingleStore consumer](../../fixtures/database-singlestore) adds database-specific capability and refusal checks.
