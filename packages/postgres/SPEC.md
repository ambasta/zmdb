...
The package depends on `@zmdb/migrations`, `@zmdb/sql` and `@zmdb/orm`. `pg` is an optional peer and a development dependency for tests, never a dependency of a generic package or of the default
