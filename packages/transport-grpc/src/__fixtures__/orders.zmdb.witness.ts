/*zmdb:imports*/
// Generated by @zmdb/compiler from src/__fixtures__/orders.ts. Checked, not edited.
//
// One wrapper per validation call src/__fixtures__/orders.ts used to make, written against the runtime
// API so that the compiler still sees each type argument. That is the point of the file: it
// is what project compilation reads on the next run to regenerate the compiled module, and it is
