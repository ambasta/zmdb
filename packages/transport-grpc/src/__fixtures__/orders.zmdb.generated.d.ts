// Generated by @zmdb/compiler from src/__fixtures__/orders.ts. Do not edit.
//
// The validators, compiled. Every check below was emitted from a type in src/__fixtures__/orders.ts's
