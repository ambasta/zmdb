...
describe('the protobuf boundary', () => {
  ...
  it('the gRPC surface is reachable only through @zmdb/transport/grpc', () => {
    ...
    expect(transport.exports?.['./grpc']).toBe('./src/grpc/index.ts');
    expect(transport.exports?.['.']).toBeUndefined();
