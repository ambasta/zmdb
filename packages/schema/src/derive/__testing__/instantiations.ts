...
const DERIVE_IMPORT =
  "import type { Entity, CreateDTO, UpdateDTO, ReadDTO, WhereDTO, OrderByDTO, PrimaryKeyOf, Wire, ListDTO, GetDTO } from '@zmdb/schema/derive';";
const TAGS_IMPORT =
  "import type { HasDefault, Length, Max, Min, MinLength, Pattern, PrimaryKey, Sensitive, Serial, Sql, Table, Unique } from '@zmdb/schema/tags';";
