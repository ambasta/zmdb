...
```bash
yarn add @zmdb/ai@1.0.0-beta.2 @zmdb/ai-langchain@1.0.0-beta.2 @langchain/core@^1.2.9
```

> **Prerelease** (`1.0.0-beta.2`). Requires **Node.js 26+** and is **ESM-only**. `@langchain/core` is an optional peer used by applications that construct a real LangChain tool.
