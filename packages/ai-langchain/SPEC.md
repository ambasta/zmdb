...
This package owns the LangChain-specific tool-object translation in `packages/ai-langchain/src/index.ts`. It accepts the provider-neutral schema/tool contract from `@zmdb/ai`, returns the structural
