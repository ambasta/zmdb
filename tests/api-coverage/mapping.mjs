...
export const kysely = {
  ...
  'schema > create index': ['creates a non-unique index', 'creates a unique, multi-column, partial index'],
...
export const mikroOrm = {
  ...
  'custom-types': ['round-trips', 'flatten prefixes each field with the column prefix'],
  embeddables: [
  ...
  naming: 'names every declared column in every dialect',
  ...
  'raw-queries': 'allows unmapped raw Postgres/SQL operators to fall through as-written',
  'read-replicas': [
