...
export const PRODUCT_CATALOG = Object.freeze([
  ...
  productPackage({
    ...
    role: 'cockroach',
    facade: { root: [], subpaths: ['zmdb/cockroach'] },
  ...
  productPackage({
    ...
    npmName: '@zmdb/mssql',
    role: 'mssql',
    facade: { root: [], subpaths: ['zmdb/mssql'] },
  ...
  productPackage({
    ...
    npmName: '@zmdb/mysql',
    role: 'mysql',
    facade: { root: [], subpaths: ['zmdb/mysql'] },
  ...
  productPackage({
    ...
    role: 'postgres',
    facade: { root: [], subpaths: ['zmdb/postgres'] },
  ...
  productPackage({
    ...
    role: 'singlestore',
    facade: { root: [], subpaths: ['zmdb/singlestore'] },
  ...
  productPackage({
    ...
    npmName: '@zmdb/sqlite',
    role: 'sqlite',
    facade: { root: [], subpaths: ['zmdb/sqlite'] },
