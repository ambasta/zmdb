...
export const PRODUCT_CATALOG = Object.freeze([
  productPackage({
    ...
    optionality: { kind: 'integration', technology: 'provider-neutral AI tools and provider adapters' },
  ...
  productPackage({
    ...
    role: 'client',
    facade: { root: [], subpaths: [] },
    optionality: { kind: 'integration', technology: 'generated HTTP clients and framework bindings' },
  ...
  productPackage({
    ...
    npmName: '@zmdb/transport',
    role: 'transport',
    facade: { root: [], subpaths: [] },
    optionality: { kind: 'integration', technology: 'gRPC and broker transports' },
