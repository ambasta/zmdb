...
export const PRODUCT_CATALOG = Object.freeze([
  ...
  productPackage({
    ...
    npmName: '@zmdb/cli',
    role: 'cli',
    facade: { root: [], subpaths: ['@zmdb/core/cli'] },
  ...
  productPackage({
    ...
    role: 'cockroach',
    facade: { root: [], subpaths: ['@zmdb/core/cockroach'] },
  ...
  productPackage({
    ...
    facade: {
      ...
      subpaths: ['@zmdb/core/compiler', '@zmdb/core/config', '@zmdb/core/testing'],
    },
    optionality: { kind: 'tooling' },
    docsOwner: 'aot-setup',
  ...
  productPackage({
    ...
    role: 'jobs',
    facade: { root: [], subpaths: [] },
    optionality: { kind: 'capability', capability: 'jobs' },
  ...
  productPackage({
    ...
    role: 'migrations',
    facade: { root: [], subpaths: ['@zmdb/core/migrations'] },
    optionality: { kind: 'tooling' },
  ...
  productPackage({
    ...
    npmName: '@zmdb/mssql',
    role: 'mssql',
    facade: { root: [], subpaths: ['@zmdb/core/mssql'] },
  ...
  productPackage({
    ...
    npmName: '@zmdb/mysql',
    role: 'mysql',
    facade: { root: [], subpaths: ['@zmdb/core/mysql'] },
  ...
  productPackage({
    ...
    role: 'postgres',
    facade: { root: [], subpaths: ['@zmdb/core/postgres'] },
  ...
  productPackage({
    ...
    role: 'singlestore',
    facade: { root: [], subpaths: ['@zmdb/core/singlestore'] },
  ...
  productPackage({
    ...
    npmName: '@zmdb/sql',
    role: 'sql',
    facade: { root: [], subpaths: ['@zmdb/core/sql'] },
    optionality: { kind: 'required' },
    docsOwner: 'raw-sql',
    consumer: { reason: PUBLISH_VERIFIER_REASON },
  }),
  productPackage({
    ...
    npmName: '@zmdb/sqlite',
    role: 'sqlite',
    facade: { root: [], subpaths: ['@zmdb/core/sqlite'] },
