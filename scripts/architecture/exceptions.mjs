...
const RUNTIME_LEGACY_IMPORT_DEBT = Object.freeze([
  ...
  [
    ...
    [
      'fixtures/consumer-cli/projects/data/src/validate.ts',
  ...
  [
    ...
    [
      ...
      'packages/cli/src/migration-project.ts',
      'packages/cli/src/studio/index.ts',
  ...
  [
    ...
    ['packages/cli/src/studio/index.ts', 'packages/repository/src/index.ts', 'packages/zmdb/src/sql.ts'],
    639,
  ],
  [
  ...
  [
    ...
    ['packages/ai/src/http/parse.ts', 'packages/cli/src/studio/index.ts', 'packages/zmdb/src/schema.ts'],
    638,
  ],
  ['@zmdb/schema-core/relations', ['packages/cli/src/studio/index.ts', 'packages/zmdb/src/relations.ts'], 638],
  [
    '@zmdb/schema-core/tags',
    [
      'fixtures/consumer-cli/projects/data/src/user.ts',
      'fixtures/consumer-compiler/src/model.ts',
      'packages/compiler/src/emit/__testing__/project.ts',
