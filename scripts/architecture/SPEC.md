...
> **Status:** target contract frozen by issue #722 for epic #721 and amended for the packages admitted by #656, #682, #705, #647, #650, #706, #707, #708, #709, #662, #669, #691, #657, #658, #659,
> #660, #661, and the #710 AI ownership cutover. Issue #724 implements the canonical policy plus read-only discovery and graph APIs; #725 implements architecture-zone, ring and workspace-edge
...
Issues #656, #682, #705, #647, #650, #706, #707, #708, #709, #662, #669, #691, #657, #658, #659, #660, and #661 add `@zmdb/protobuf`, `@zmdb/client`, `@zmdb/ai`, `@zmdb/app`, `@zmdb/jobs`,
`@zmdb/ai-anthropic`, `@zmdb/ai-langchain`, `@zmdb/ai-vercel`, `@zmdb/mcp`, `@zmdb/otel`, `@zmdb/sqlite`, `@zmdb/react`, `@zmdb/transport-grpc`, `@zmdb/transport-nats`, `@zmdb/transport-rabbitmq`, and
`@zmdb/transport-redis`, and `@zmdb/jobs-postgres`. Issue #710 removed the temporary LangChain-to-schema-core edge. The current twenty-three manifests keep `1.0.0-alpha.4`, declare 41 direct non-dev
workspace edges, and declare 15 peer dependencies: 8 optional peers plus required OpenTelemetry, React, grpc-js, NATS, RabbitMQ, Redis, and PostgreSQL peers confined to their selected integration
packages.
...
The following object is normative. It constrains the current twenty-three catalog members, and the runtime-reachability gate verifies every present export and executable against it. Adding, removing
...
`@zmdb/react`, `@zmdb/otel`, `@zmdb/transport-grpc`, `@zmdb/transport-nats`, `@zmdb/transport-rabbitmq`, `@zmdb/transport-redis`, and `@zmdb/jobs-postgres` reach their required peers under §5.4, so
they do not use an ordinary-runtime dependency allowance.
