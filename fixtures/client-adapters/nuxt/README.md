...
This fixture is copied into a temporary project by `packages/nuxt/src/packed-consumer.spec.ts`. The project installs packed `@zmdb/client`, `@zmdb/client/vue`, and `@zmdb/nuxt` tarballs plus Nuxt
4.5.2, then:
