...
import { createApplication as facadeCreateApplication } from '@zmdb/core/app';
import { createCommandApp as facadeCreateCommandApp } from '@zmdb/core/app/commands';
import { createCommandBus as facadeCreateCommandBus } from '@zmdb/core/app/cqrs';
import { repositoryToken as facadeRepositoryToken } from '@zmdb/core/app/data';
import { Container as FacadeContainer } from '@zmdb/core/app/di';
import { createEvents as facadeCreateEvents } from '@zmdb/core/app/events';
import { databaseReadinessCheck as facadeDatabaseReadinessCheck } from '@zmdb/core/app/health';
import type { OnShutdown as FacadeOnShutdown } from '@zmdb/core/app/lifecycle';
import { createMessageDispatcher as facadeCreateMessageDispatcher } from '@zmdb/core/app/messaging';
import { Module as FacadeModule } from '@zmdb/core/app/modules';
import { SpanKind as FacadeSpanKind } from '@zmdb/core/app/observability';
import { defineState as facadeDefineState } from '@zmdb/core/app/state';
import { Controller as FacadeController } from '@zmdb/core/web';
import { createApp as facadeCreateApp } from '@zmdb/core/web/app';
import { compress as facadeCompress } from '@zmdb/core/web/compression';
import { extractParams as facadeExtractParams } from '@zmdb/core/web/context';
import { defineHttpContract as facadeDefineHttpContract } from '@zmdb/core/web/contract';
import { compileHttpContracts as facadeCompileHttpContracts } from '@zmdb/core/web/contract/compiler';
import { createCsrf as facadeCreateCsrf } from '@zmdb/core/web/csrf';
import { validateWith as facadeValidateWith } from '@zmdb/core/web/data';
import { describeGraph as facadeDescribeGraph } from '@zmdb/core/web/devtools';
import { validationPipe as facadeValidationPipe } from '@zmdb/core/web/dto-pipes';
import { Gateway as FacadeGateway } from '@zmdb/core/web/gateways';
import { healthRoutes as facadeHealthRoutes } from '@zmdb/core/web/health';
import { runChain as facadeRunChain } from '@zmdb/core/web/middleware';
import { toOpenApi as facadeToOpenApi } from '@zmdb/core/web/openapi';
import { createRouter as facadeCreateRouter } from '@zmdb/core/web/pipeline';
import { Get as FacadeGet } from '@zmdb/core/web/routing';
import { createStaticHandler as facadeCreateStaticHandler } from '@zmdb/core/web/static';
import { createTestApp as facadeCreateTestApp } from '@zmdb/core/web/testing';
import { parseMultipart as facadeParseMultipart } from '@zmdb/core/web/upload';
import { Version as FacadeVersion } from '@zmdb/core/web/versioning';
