...
async function metroBase() {
  ...
  const workspacePackages = {
    ...
    '@zmdb/sql': resolve(repoRoot, 'packages/sql'),
    '@zmdb/client/react': resolve(repoRoot, 'packages/client/src/react'),
    '@zmdb/client/react-native': resolve(repoRoot, 'packages/client/src/react-native'),
    '@zmdb/orm': resolve(repoRoot, 'packages/orm'),
    '@zmdb/schema': resolve(repoRoot, 'packages/schema'),
